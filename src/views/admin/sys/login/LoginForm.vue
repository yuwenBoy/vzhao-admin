<template>
  ...
  <Form class="p-4 enter-x" :model="formData" :rules="getFormRules" v-show="getShow" ref="formRef" @keypress.enter="handleLogin">
    ...
    <FormItem class="enter-x">
      ...
      <Button size="large" class="mt-4 enter-x" block @click="setLoginState(LoginStateEnum.REGISTER)">注册</Button>
    </FormItem>
    <ARow class="enter-x">
...
import { Checkbox, message, Col, Form, Input, Row, Button, Divider } from 'ant-design-vue';
